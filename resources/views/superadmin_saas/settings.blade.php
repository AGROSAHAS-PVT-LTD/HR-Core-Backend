    ...
    <div class="col-12 col-lg-4">
      <div class="d-flex justify-content-between flex-column mb-4 mb-md-0">
        ...
        <ul class="nav nav-align-left nav-pills flex-column" id="settingsMenu">
          ...
          @endif
          <li class="nav-item mb-1">
            <a class="nav-link" href="?tab=paymentGateways" data-bs-toggle="pill" data-bs-target="#paymentGateways">
              <i class="bx bx-buildings bx-sm me-1_5"></i> Payment Gateways
            </a>
          </li>
        </ul>
      </div>
    ...
    <div class=" col-12 col-lg-8 pt-6 pt-lg-0">
      <div class="tab-content p-0">
        ...
        <!-- /Company Settings -->
         ...
         <!-- Payment Gateways -->
        <div class="tab-pane fade" id="paymentGateways">
        <form action="{{ route('superadmin.pay.settings') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0"><i class="fas fa-credit-card me-2"></i> Payment Gateways Configuration</h5>
            </div>
            <div class="card-body">
                
                <!-- Offline Payment Section -->
                <div class="gateway-section mb-4 p-4 border rounded">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <input class="form-check-input" type="checkbox" role="switch" 
                            id="enableOfflinePayment" name="enable_offline_payment" value="1"
                            {{ $settings->enable_offline_payment ? 'checked' : '' }}>
                    <label class="form-check-label" for="enableOfflinePayment">Enable Offline Payment</label>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                    <div class="mb-3">
                        <label for="offline_payment_details" class="form-label">
                        Payment Instructions
                        <i class="fas fa-info-circle text-primary ms-1" 
                            data-bs-toggle="tooltip" 
                            title="Enter bank account details or other offline payment instructions"></i>
                        </label>
                        <textarea class="form-control" rows="4" name="offline_payment_details" 
                                id="offline_payment_details" placeholder="Bank name: ABC Bank
                                    Account name: Your Business Name
                                    Account number: 123456789
                                    Branch: Main Branch">{{ $settings->offline_payment_details }}</textarea>
                    </div>
                    </div>
                </div>
                </div>
                ...
                <div class="gateway-section mb-4 p-4 border rounded">
                <h4 class="mb-3">
                    <i class="fas fa-money-bill-wave me-2"></i> Flutterwave
                    <span class="badge bg-info ms-2">Africa</span>
                </h4>
                ...
                <div class="row g-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="FLUTTERWAVE_PUBLIC_KEY" 
                            name="flutterwave_public_key" value="{{ $settings->flutterwave_public_key }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="FLUTTERWAVE_SECRET_KEY" 
                            name="flutterwave_secret_key" value="{{ $settings->flutterwave_secret_key }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="FLUTTERWAVE_ENCRYPTION_KEY" 
                            name="flutterwave_encryption_key" value="{{ $settings->flutterwave_encryption_key }}"
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                    <div class="mb-3">
                        <label for="STRIPE_PUB_KEY" class="form-label">Publishable Key</label>
                        <input type="text" class="form-control" id="STRIPE_PUB_KEY" 
                            name="stripe_pub_key" value="{{ $settings->stripe_pub_key }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="STRIPE_SECRET_KEY" 
                            name="stripe_secret_key" value="{{ $settings->stripe_secret_key }}"
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                    <div class="mb-3">
                        <label for="PAYPAL_MODE" class="form-label">Environment Mode</label>
                        ...
                        <i class="fas fa-exclamation-triangle me-1"></i> Set to Live for actual payments
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="col-md-4">
                    <div class="mb-3">
                        <label for="PAYPAL_APP_SECRET" class="form-label">App Secret</label>
                        <input type="text" class="form-control" id="PAYPAL_APP_SECRET" 
                            name="paypal_app_secret" value="{{ $settings->paypal_app_secret }}"
                ...
                <div class="gateway-section mb-4 p-4 border rounded">
                <h4 class="mb-3">
                    <i class="fas fa-money-check-alt me-2"></i> Pesapal
                    <span class="badge bg-info ms-2">Kenya</span>
                    <small class="text-muted">(KES currency)</small>
                </h4>
                ...
                <div class="row g-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="pesapal_consumer_key" 
                            name="pesapal_consumer_key" value="{{ $settings->pesapal_consumer_key }}"
                            placeholder="XXXXXXXXXXXXXXXXXXXXXXXX">
                    </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="pesapal_consumer_secret" 
                            name="pesapal_consumer_secret" value="{{ $settings->pesapal_consumer_secret }}"
                            placeholder="XXXXXXXXXXXXXXXXXXXXXXXX">
                    </div>
                    </div>
                    ...
                    <div class="col-md-4">
                    <div class="mb-3">
                        <label for="PESAPAL_LIVE" class="form-label">Environment</label>
                        <select class="form-select" id="PESAPAL_LIVE" name="pesapal_live">
                        <option value="0" {{ !$settings->pesapal_live ? 'selected' : '' }}>Sandbox (Testing)</option>
                        <option value="1" {{ $settings->pesapal_live ? 'selected' : '' }}>Live (Production)</option>
                        </select>
                    </div>
                    </div>
                </div>
                ...
                <div class="gateway-section mb-4 p-4 border rounded">
                <h4 class="mb-3">
                    <i class="fas fa-money-bill-alt me-2"></i> Paystack
                    <span class="badge bg-info ms-2">Nigeria/Ghana</span>
                    <small class="text-muted">(NGN, GHS currencies)</small>
                </h4>
                ...
                <div class="row g-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="paystack_public_key" 
                            name="paystack_public_key" value="{{ $settings->paystack_public_key }}"
                            placeholder="pk_test_XXXXXXXXXXXXXXXXXXXXXXXX">
                    </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="paystack_secret_key" 
                            name="paystack_secret_key" value="{{ $settings->paystack_secret_key }}"
                            placeholder="sk_test_XXXXXXXXXXXXXXXXXXXXXXXX">
                    </div>
                    </div>
                </div>
